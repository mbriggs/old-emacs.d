...
(evil-ex-define-cmd "create-spec" 'railgun-create-spec)
(evil-ex-define-cmd "create-test" 'railgun-create-test)
(evil-ex-define-cmd "create-model" 'railgun-create-model)
(evil-ex-define-cmd "create-controller" 'railgun-create-controller)
(evil-ex-define-cmd "create-helper" 'railgun-create-helper)
